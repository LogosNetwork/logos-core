...
int CAddrInfo::GetTriedBucket(const uint512& nKey) const
{
...
int CAddrInfo::GetNewBucket(const uint512& nKey, const CNetAddr& src) const
{
...
int CAddrInfo::GetBucketPosition(const uint512 &nKey, bool fNew, int nBucket) const
{
