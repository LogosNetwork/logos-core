...
static const Minutes EPOCH_DELEGATES_CONNECT(1); // 5 minunes TODO change to 5, 1 is used for testing
...
static const Seconds SECONDARY_LIST_TIMEOUT(10); // 10 seconds
