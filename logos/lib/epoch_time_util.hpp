...
//static const Minutes EPOCH_PROPOSAL_TIME(10); // 12 hours
...
static const Minutes MICROBLOCK_PROPOSAL_TIME(360); // 10 minutes
static const Minutes MICROBLOCK_CUTOFF_TIME(360); // 10 minutes
