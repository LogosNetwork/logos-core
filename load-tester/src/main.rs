...
// found in secure.cpp
const GENESIS_ACCOUNT: &str = "lgs_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo";
...
fn main() {
    env_logger::init();
    let matches = clap::App::new("logos-load-tester")
        ...
        .arg(
            Arg::with_name("tmp_dir")
                .long("tmp-dir")
                .value_name("PATH")
                .help("The path to a temporary directory for logos_core data"),
        )
        .arg(
            Arg::with_name("node_path")
                .value_name("PATH")
                .required(true)
                .help("The path to the logos_core to test"),
        )
        .arg(
